...
const LeafletQuickMap = () => {
  ...
  return (
    <ComponentContainerCard title="Leaflet Quick Start Guide">
      <div style={{ height: 400 }}>
        <MapContainer center={position} maxZoom={18} zoom={13} scrollWheelZoom={true} style={{ height: '400px' }}>
          <TileLayer
...
const VectorBoundMap = () => {
  ...
  return (
    <ComponentContainerCard title="Vector Bounds">
      <div style={{ height: 400 }}>
        <MapContainer center={position} maxZoom={18} zoom={12} scrollWheelZoom={true} style={{ height: '400px' }}>
          <TileLayer
            attribution='&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
            url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png"
          />
...
const SimpleVectorMap = () => {
  ...
  return (
    <ComponentContainerCard title="Simple Vector Map">
      <MapContainer center={position} zoom={13} maxZoom={18} scrollWheelZoom style={{ height: '400px' }}>
        <TileLayer
          attribution='&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
          url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png"
        />
...
const LayerControlMap = () => {
  ...
  return (
    <ComponentContainerCard title="Layers control">
      <MapContainer center={center} zoom={13} maxZoom={18} scrollWheelZoom={true} style={{ height: 400 }}>
        <TileLayer
          attribution='&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
          url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png"
        />
...
const TooltipMap = () => {
  ...
  function TooltipCircle() {
    ...
    return (
      <Circle center={center} eventHandlers={eventHandlers} pathOptions={{ fillColor: 'blue' }} radius={200}>
  ...
  return (
    <ComponentContainerCard title="Tooltips">
      <MapContainer center={center} zoom={13} maxZoom={18} scrollWheelZoom style={{ height: 400 }}>
        <TileLayer
          attribution='&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
          url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png"
        />
