...
const AllAnimations = () => {
  const [animation, setAnimation] = useState<object | null>()

  const toggleAnimation = (animation: object) => {
        ...
        <div className="position-relative d-inline-block mx-auto">
          <div id="animate-me" className={css(animation)}>
            <div className="shadow-sm p-4 d-inline-block rounded-circle">
              <Image src={logoSm} alt="logo-sm" className="center-block thumb-xl" />
            </div>
          </div>
        </div>
      </div>
      <div className="mt-5">
        <Row>
          <Col lg="6" id="content" className="mx-auto text-center button-list container-magic-bottom container text-center">
            <SimplebarReactClient style={{ height: 450 }}>
              ...
              <Button
                ...
                size="sm"
                className="btn-animation me-1 mb-1"
                onClick={() => toggleAnimation(styles.openDownLeftReturn)}>
                OpenDownLeftReturn
              </Button>
              <Button
                variant="outline-secondary"
                size="sm"
                className="btn-animation me-1 mb-1"
                onClick={() => toggleAnimation(styles.openDownRightReturn)}>
                OpenDownRightReturn
              </Button>
              <Button
                variant="outline-secondary"
              ...
              <Button
                ...
                size="sm"
                className="btn-animation me-1 mb-1"
                onClick={() => toggleAnimation(styles.openUpRightReturn)}>
                OpenUpRightReturn
              </Button>
              ...
              <Button
                ...
                size="sm"
                className="btn-animation me-1 mb-1"
                onClick={() => toggleAnimation(styles.perspectiveDownReturn)}>
                PerspectiveDownReturn
              </Button>
              <Button
                variant="outline-secondary"
                size="sm"
                className="btn-animation me-1 mb-1"
                onClick={() => toggleAnimation(styles.perspectiveUpReturn)}>
                PerspectiveUpReturn
              </Button>
              <Button
                variant="outline-secondary"
                size="sm"
                className="btn-animation me-1 mb-1"
                onClick={() => toggleAnimation(styles.perspectiveLeftReturn)}>
                PerspectiveLeftReturn
              </Button>
              <Button
                variant="outline-secondary"
                size="sm"
                className="btn-animation me-1 mb-1"
                onClick={() => toggleAnimation(styles.perspectiveRightReturn)}>
                PerspectiveRightReturn
              </Button>
