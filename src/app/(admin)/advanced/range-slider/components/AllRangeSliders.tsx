...
const DefaultSlider = () => {
  return (
    <ComponentContainerCard title="Default Slider">
      <Nouislider range={{ min: 0, max: 100 }} start={[50]} />
...
const SliderWithTooltip = () => {
  return (
    <ComponentContainerCard title="Only showing tooltips when sliding handles">
...
const InputElementSlider = () => {
  ...
  return (
    <ComponentContainerCard title="Using HTML5 input elements">
      <Nouislider range={{ min: -20, max: 40 }} start={selectedValue} connect={true} className="mb-3" onSlide={handleSliderChange} />
      <Row>
        <Col xs="3">
...
const WorkingWithDateSlider = () => {
  const timestamp = (str: any) => {
    return new Date(str).getTime()
  }
  return (
    <ComponentContainerCard title="Working with dates">
      <Nouislider
...
const SkippingStepSlider = () => {
  ...
  const handleSkippingSteps = (e: any) => {
    setSkipingStep(e)
  }
  return (
    <ComponentContainerCard title="Skipping steps">
      <Nouislider
        range={{
          min: 0,
          '10%': 10,
...
const ClickingPipsSlider = () => {
  return (
    <ComponentContainerCard title="Moving the slider by clicking pips">
      <div className="pb-4">
