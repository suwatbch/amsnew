...
import type { FolderType } from '@/types/data'
...
const FolderCard = ({ folder }: { folder: FolderType }) => {
  const { files, image, progress, storage, title } = folder
  return (
    <Card>
      <CardBody>
        ...
        <div className="d-flex align-items-center">
          <div className="flex-grow-1 text-truncate">
            <div className="d-flex align-items-center">
              <ProgressBar variant="secondary" now={progress} style={{ height: 5 }} className="w-100" />
