...
const BootstrapCustomStyle = () => {
  ...
  return (
    <ComponentContainerCard title="Bootstrap Custom Styles">
...
const Tooltips = () => {
  ...
  return (
    <ComponentContainerCard title="Validation Tooltips">
      <Form className="row g-3 needs-validation" noValidate validated={validated} onSubmit={handleSubmit}>
...
const CustomValidation = () => {
  ...
  return (
    <ComponentContainerCard title="Custom Validation Form">
