...
const Tabs = () => {
  return (
    <ComponentContainerCard title="Tabs">
...
const Pills = () => {
  return (
    <ComponentContainerCard title="Pills">
      <TabContainer defaultActiveKey="1">
  ...
  const tabContents: TabContentItem[] = [
    {
      ...
      title: 'Home',
      description:
        'Trust fund seitan letterpress, keytar raw denim keffiyeh etsy art party before they sold out master cleanse gluten-free squid scenester freegan cosby sweater.',
    },
    {
      id: '2',
      title: 'Profile',
      description:
        "Food truck fixie locavore, accusamus mcsweeney's marfa nulla single-origin coffee squid. Exercitation +1 labore velit, blog sartorial PBR leggings next level wes anderson.",
    },
    {
      id: '3',
      title: 'Settings',
      description:
        'Exercitation commodo enim craft beer mlkshk +1 labore velit, blog sartorial PBR leggings next level wes anderson artisan four loko farm-to-table craft beer twee. Qui photo booth letterpress.',
    },
  ]
  return (
    <ComponentContainerCard title="Vertical Pills">
      <TabContainer defaultActiveKey="1">
        <Row>
          <Col sm={4} lg={3}>
          ...
          <Col sm={8} lg={9}>
            <TabContent className="mo-mt-2">
              {tabContents.map((tab, idx) => {
                return (
                  <TabPane key={idx} eventKey={tab.id} className="fade" role="tabpanel">
...
const CustomTabs = () => {
  ...
  return (
    <ComponentContainerCard title="Custom Tabs">
      <TabContainer defaultActiveKey="1">
        ...
        <TabContent className="mo-mt-2">
          {tabContents.map((tab, idx) => {
            return (
              <TabPane key={idx} eventKey={tab.id} className="p-3" role="tabpanel">
                <p className="mb-0 text-muted">{tab.description}</p>
              </TabPane>
            )
          })}
