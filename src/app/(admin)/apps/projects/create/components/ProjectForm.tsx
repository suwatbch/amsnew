...
const ProjectForm = () => {
  ...
  return (
    <form className="p-4 pt-3" onSubmit={handleSubmit(() => {})}>
      ...
      <div className="form-group">
        <Row>
          <DateFormInput
            ...
            containerClassName="col-lg-3 col-6 mb-2 mb-lg-1"
          />
          <DateFormInput
            name="endDate"
            control={control}
      ...
      <div className="form-group">
        <Row>
          <SelectFormInput
            ...
            label="Required"
            labelClassName="mt-2"
            containerClassName="col-lg-6 mb-2 mb-lg-1"
            options={[
              { value: '', label: '--Select--' },
          ...
          <SelectFormInput
            ...
            label="Invoice Time"
            labelClassName="mt-2"
            containerClassName="col-lg-3 col-6"
            options={[
