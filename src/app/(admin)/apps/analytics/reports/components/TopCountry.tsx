    ...
    <Card>
      ...
      <CardBody className="pt-0">
        {topCountriesData.map((country, idx) => (
          <div className={clsx('d-flex align-items-center', topCountriesData.length - 1 === idx ? 'pt-3' : 'py-3 border-dashed-bottom')} key={idx}>
            <Image src={country.countryFlag} className="thumb-sm align-self-center rounded-circle" alt="..." />
