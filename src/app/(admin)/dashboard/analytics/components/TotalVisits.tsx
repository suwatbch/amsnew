...
const TotalVisits = () => {
  return (
    <ComponentContainerCard title="Total Visits">
            ...
            {visits.map((visit, idx) => (
              <tr key={idx}>
                ...
                <td>
                  ...
                  {visit.change}%{' '}
                  <IconifyIcon
                    icon={`fa6-solid:${visit.changeVariant === 'danger' ? 'caret-down' : 'caret-up'}`}
                    className={`text-${visit.changeVariant} font-16`}
                  />
                </td>
              </tr>
            ))}
      ...
      <p className="m-0 fs-12 fst-italic ps-2 text-muted">
        ...
        <Link href="" className="link-danger ms-1 ">
